...
public class TestGetData {
    public static void main(String[] args) {
        ...
        String[] pathDesc= "2.2.1".split("\\.");
        String[] propertyPath = "freeDetail001.freeDetail002.productId_name".split("\\.");
        ...
        for (int i = 0; i <pathDesc.length ; i++) {
            if (i==0){
                ...
                if (pathDesc[i-1].equals("2") && !pathDesc[i].equals("2")){
                    ...
                    modelData+=".getRowModel(modelData.getFocusedRowIndex()+1).get("+propertyPath[i]+")";
                }else  {
                    //modelData="modelData?.get(propertyPath[i])";
...
//                  modelData = modelData?.getRowModel(modelData.getFocusedRowIndex()+1).get(propertyPath[i])
//                } else {
//                  modelData = modelData?.get(propertyPath[i])
//                }
//              }
